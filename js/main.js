...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoicmV2YW50aDY0IiwiYSI6ImNqbjk0ODBpaDBteTczcWxneTNxODhoM3IifQ.nd9xdPGWxwPam-8FacVbpg',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  // image.sizes = `(max-width: 600px) 300px, (max-width: 900px) 600px, 800px`;
  image.alt = restaurant.name + 'restaurant promotional image';
  li.append(image);
  const text = document.createElement('div');
  text.className = 'restaurant-text-area';
